...
export class CartQuotesService {
  ...
  async dupplyCartQuote(id: string) {
    const cartQuote: CartQuote = await this.cartQuoteRepository.findOne({
      ...
      relations: [
        'orderListDetail',
        'orderListDetail.markingServices',
        'orderListDetail.orderRating',
        'orderListDetail.purchaseOrder',
        'orderListDetail.state',
        'orderListDetail.supplierPurchaseOrder',
        'orderListDetail.transportService',
        'quoteDetails',
        'state',
      ],
    });
